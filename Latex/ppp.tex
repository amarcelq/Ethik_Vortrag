...
%		& 
%		
%		\scriptsize{Kapitalgetriebene Entscheidungen~\cite{khan_aziz_2019}} & \scriptsize{Unfairen Vorteil verschaffen~\cite{khan_aziz_2019} }\\ 
%		& \scriptsize{ Neuro-Marketing~\cite{khan_aziz_2019}}& \scriptsize{ Militante Interessen~\cite{khan_aziz_2019}}\\
%		\scriptsize{ Gefahren bei Operationen~\cite{Burwell:2017aa}}& \scriptsize{ Monopolbildung~\cite{khan_aziz_2019}}& \scriptsize{ Verlust Autonomie und Menschlichkeit~\cite{Burwell:2017aa}}\\
%		&&
	\end{tabular}
	\end{table}
\end{frame}
