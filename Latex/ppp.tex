...
%\begin{tabular}{lll}
%\hline
%\multicolumn{1}{|l|}{Individuum}                                         & \multicolumn{1}{l|}{Organisationen}                                           & \multicolumn{1}{l|}{Gesellschaft}                                         \\ \hline
%\multicolumn{1}{|l|}{Folgen von Hackerangriffen$~\cite{khan_aziz_2019}$} & \multicolumn{1}{l|}{Kapitalgetriebene Entscheidungen$~\cite{khan_aziz_2019}$} & \multicolumn{1}{l|}{Unfairen Vorteil verschaffen$~\cite{khan_aziz_2019}$} \\ \hline
%Eigengefährdung von Nutzenden$~\cite{khan_aziz_2019}$                    & Neuro-Marketing$~\cite{khan_aziz_2019}$                                       & Militante Interessen$~\cite{khan_aziz_2019}$                              \\
%Gefahren bei Operationen$~\cite{Burwell:2017aa}$                         & Monopolbildung$~\cite{khan_aziz_2019}$                                        & Verlust Autonomie und Menschlichkeit$~\cite{Burwell:2017aa}$              \\
%Unbekannte Langezeitfolgen$~\cite{Burwell:2017aa}$                       &                                                                               &                                                                          
%\end{tabular}
%\end{table}
%\end{frame}
...
\begin{frame}{AI-Act}
    \begin{center}
               \raisebox{8cm}{\includegraphics[scale=0.5]{Pyramide.png}} 
    \end{center}
  \end{frame}
...
\begin{frame} %{Ungleichheit im Zugang zu technologischen Innovationen}
    ...
    \includegraphics[width=0.2\textwidth]{Fair.png}
    \hspace{1.0cm}
    \includegraphics[width=0.2\textwidth]{+.png}
    \hspace{1.0cm}
    \includegraphics[width=0.2\textwidth]{money.png}
